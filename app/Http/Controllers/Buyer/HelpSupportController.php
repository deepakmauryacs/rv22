...
class HelpSupportController extends Controller
{
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            return view('buyer.help-support.partials.table', compact('results'))->render();
        }
        return view('buyer.help-support.index',compact('results'));
    }
    ...
    public function list(Request $request)
    {
        ...
        foreach ($result as $key => $value) {
            $action = '';
            $action = '<a href="'.route('buyer.help_support.edit', $value->id).'" class="btn btn-warning btn-sm m-1">Edit</a>';
            $sub_array = array();
            $sub_array[] = ++$key;
    ...
    public function create(Request $request){
        return view('buyer.help-support.create');
    }
    ...
    public function store(Request $request){
        ...
        $data->save();
        return redirect()->route('buyer.help_support.index')->with('success','Help Support Added Successfully');
    }
    ...
    public function update(Request $request,$id){
        ...
        $data->save();
        return redirect()->route('buyer.help_support.index')->with('success','Status Updated Successfully');
    }
}