...
function addMoreBranchFields() {
    ...
    let branch_html = `
                <div class="row gy-4 branch-row" data-row-id="`+ new_row_id + `">
                    <div class='add_remove d-flex border align-items-center justify-content-between py-1 px-2 mt-3 mb-2'>
                        <h4 class="frm_head">Branch Information <span class="branch-serial-no">1</span></h4>
                        <a href="javascript:void(0);" class="ra-btn ra-btn-outline-danger" onclick='removeBranchAddField(this)'><i class="fa fa-trash"></i> Remove</a>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="branchName" class="mb-1">Branch Name<span class="text-danger">*</span></label>
                        <input type="text" class="form-control required text-upper-case mng-input" name="branch_name[]" value="" placeholder="Enter Branch Name" maxlength="255" oninput="this.value=this.value.replace(/[^a-zA-Z0-9.\&\(\)\+,\- ]/,'')">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control required branch-gstin-vat mng-input" name="branch_gstin[]" value="" placeholder="Enter GSTIN/VAT" maxlength="`+ myRules.branch_gstvat_length + `" oninput="this.value=this.value.replace(/[^a-zA-Z0-9.\&amp;\(\)\+,\- ]/,'')">
                    </div>
                    <div class="form-group col-md-12">
                        <label class="mb-1">Registered Address<span class="text-danger">*</span></label>
                        <textarea class="form-control required mng-input" name="branch_address[]" placeholder="Enter Registered Address" maxlength="1700"></textarea>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="mb-1">Country<span class="text-danger">*</span></label>
                        <select class="form-select mng-input branch-country disabled branch-country-a`+ new_row_id + ` required" name="branch_country[]"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select mng-input branch-state branch-state-a`+ new_row_id + ` `+(myRules.is_indian ? 'required' : '')+` "
                            name="branch_state[]">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mng-input branch-pincode required" name="branch_pincode[]" value=""
                        onkeypress="return validatePinCode(event, this)" placeholder="Enter Pin Code" minlength="6" maxlength="6">
                    </div>

                    <div class="form-group col-md-6">
                        <label class="mb-1">Name of Authorized Person & Designation<span class="text-danger">*</span></label>
                        <input type="text" class="form-control mng-input required" name="branch_authorized_designation[]" value="" placeholder="Enter Name of Authorized Person & Designation" oninput="this.value=this.value.replace(/[^a-zA-Z0-9.\&\(\)\+,\- ]/,'')">
                    </div>

                    <div class="form-group col-md-6">
                        <label class="mb-1">Mobile<span class="text-danger">*</span></label>
                        <input type="text" class="form-control mng-input validate-max-length my-mobile-number required" name="branch_mobile[]" value=""
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control mng-input valid-email required" name="branch_email[]" value="" placeholder="Enter Email" oninput="this.value=this.value.replace(/[^a-zA-Z0-9.\&\(\)\+\@,\- ]/,'')">
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div class="custom-file branch-toggle-div">
                            <label class="radio-inline mr-3">
                                <label class="switch">
                                    <input onchange="branchStatus(this)" class="branch-status mng-input required" value="1" type="checkbox" checked>
