                ...
                <div class="col-lg-4 col-md-12 col-12 form-detail m-auto">
                    <div class="form-forget">
                        ...
                        <div class="inner-form">
                            <form action="{{ route('admin.forgot-password.submit') }}" method="post" name="form-forget" id="form-forget">
                                @csrf
                                ...
                                <div class="form-field">
                                    <span class="count_first px-3">{{$number_first}}</span>
                                    <span>+</span>
                                    <span class="count_snd px-3">{{$number_second}}</span>
                                    <span>=</span>
                                    <input type="text" name="total_number" class="count_output">
                                </div>
                                <div class="form-field">
