        ...
        <table style="table-layout: fixed; width: 100%; border-bottom: 1px solid #000;">
            <tr>
                <td style="">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 style="text-align: right; padding-right: 5px;">ORDER GENERATED THROUGH<br><img height="30" width="150" src="{{ asset('public/assets/images/rfq-logo.png') }}" style="margin-top: 8px;" />
                        </h3>
                        </div>
                    </div>
                </td>
