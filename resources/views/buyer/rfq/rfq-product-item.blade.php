...
<div class="card-vendor-list-right-panel">
    ...
    <div class="card shadow-sm px-3 pt-3 card-vendor-list-item pb-0 mb-3">
        <form class="rfq-product-row product-form-section" action="" id="product-form-id-{{$row['masterProduct']->id}}" enctype="multipart/form-data">
                    ...
                    <thead>
                        <tr>
                            <th scope="col" class="text-nowrap">
                                <div class="table-product-list-sl">Sr. No.</div>
                            </th>
                            <th scope="col" class="text-nowrap">
                                        ...
                                        <div class="file-info" style="display: {{ !empty($attachment) ? 'block' : 'none' }};">
                                            @if(!empty($attachment))
                                                <div class="d-flex align-item-center gap-1">
                                                    <a class="file-links display-file" href="{{ url('public/uploads/rfq-attachment/'.$variant->attachment) }}" target="_blank" download="{{ $variant->attachment }}">
