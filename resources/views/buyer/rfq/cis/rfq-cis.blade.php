                                                ...
                                                <td class="align-middle p-1">
                                                    ...
                                                    @if(!empty($variant_quotes))
                                                        ...
                                                        @foreach ($variant_quotes as $item)
                                                            ...
                                                            @endphp
                                                        @endforeach
                                                        <span role="botton" type="button" class="p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ implode(', ', array_unique($variant_quote_history)) }}">
                                                            <span class="bi bi-info-circle-fill text-dark font-size-11" aria-hidden="true"></span>
                                                        </span>
                                            ...
                                            <tr>
                                                @foreach($cis['vendors'] as $vendor_id => $vendor)
                                                    @php
                                                        ...
                                                        $technical_approval = !empty($vendor['technical_approval']) ? $vendor['technical_approval'] : [];
                                                    @endphp
                                                <td class="product-price p-1 align-middle text-center" title="Technical Approval">
                                                    <span role="button" type="button" class="p-0 technical-approval"
                                                        data-vendor-id="{{ $vendor_id }}" data-vendor-name="{{ $vendor['legal_name'] }}"
                                                        data-technical-approval-description="{{ !empty($technical_approval) ? $technical_approval['description'] : '' }}"
                                                        data-technical-approval="{{ !empty($technical_approval) ? $technical_approval['technical_approval'] : '' }}" title="Technical Approval">
                                            ...
                                            <tr>
                                                @foreach($cis['vendors'] as $vendor_id => $vendor)
                                                    @php
                                                        ...
                                                        $technical_approval = !empty($vendor['technical_approval']) ? $vendor['technical_approval'] : [];
                                                    @endphp
                                                <td class="product-price p-1 align-middle text-center" title="Technical Approval Remarks">
                                                    @if(!empty($technical_approval))
                                                        ...
                                                        <span role="botton" type="button" class="p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $technical_approval['description'] }}">
                                                            <span class="bi bi-info-circle-fill text-dark font-size-11" aria-hidden="true"></span>
                                                            <span class="visually-hidden-focusable">info</span>
                                                        </span>
                                                        @endif
            ...
            <section class="floting-product-options cis-floating-button d-none d-sm-block">
                <div class="d-flex flex-wrap flex-md-nowrap align-items-center justify-content-center gap-3">
                    <button type="button"
                        ...
                        <span class="bi bi-calendar-date font-size-12" aria-hidden="true"></span> {{$rfq['is_auction'] == 1 ? 'VIEW/EDIT AUCTION' : 'CREATE AUCTION' }}
                    </button>
                    <button type="button"
                ...
                <div class="modal-body">
                    <div class="pt-3">
                        <div class="form-group">
                            <input type="radio" name="check-cis-po" id="checkLastCis" value="cis" checked onchange="checkCisPo();">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="technical-approval-form" action="javascript:void(0)" method="POST">
                        <div class="message pt-2">
                            <input type="hidden" value="" name="vendor_id" class="form-control" id="technical-approval-vendor-id">
