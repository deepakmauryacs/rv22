    ...
    <tbody>
        @php
            ...
            $rfq_status = array(
                ...
                8=> "<span class='rfq-status rfq-received'>Closed RFQ</span>",
                9=> "<span class='rfq-status Partial-order'>Partial Order</span>",
                10=> "<span class='rfq-status Partial-order'>Closed with Partial Order</span>",
            );
        ...
        @forelse ($results as $result)
            ...
            <tr class="{{ $result->buyer_rfq_read_status == 1 ? 'list-unread' : '' }} ">
                ...
                <td>
                    {{date("d/m/Y", strtotime($result->scheduled_date))}}
                </td>
                <td>
        ...
        @empty
            <tr>
                <td colspan="7">No Scheduled RFQ found.</td>
            </tr>
        @endforelse
    </tbody>
</table>
