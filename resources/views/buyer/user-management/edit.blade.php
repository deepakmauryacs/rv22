                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12 col-sm-6">
                                    ...
                                    <div class="dropdown multiselect-dropdown">
                                        <button
                                            class="btn btn-outline-default custom-multiselect-dropdown-btn dropdown-toggle w-100 text-truncate"
                                                ...
                                                <li>
                                                    <label class="ra-custom-checkbox mb-0">
                                                        <input type="checkbox" name="branchId[]"
                                                            class="location-checkbox" value="{{$branche->id}}"
                                                            {{in_array($branche->id, $userBranches) ? 'checked' : ''}}>
                                    ...
                                    <small id="branchId_error" class="text-danger branchId[]_error font-size-13">
