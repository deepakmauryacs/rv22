@extends('buyer.layouts.app', ['title'=>'Favourite Vendors'])
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header py-3 bg-white">
                    <h1 class="font-size-18 mb-0">Favourite Vendors</h1>
                </div>
                <div class="card-body pt-4">
                    <form id="searchForm" action="{{ route('buyer.vendor.favourite') }}" method="GET"></form>
                    <div class="table-responsive">
                        ...
                        <!-- <div class="alert alert-warning text-center font-size-13 border-0">
                            You haven't Favourite any Vendor.
                        </div>
