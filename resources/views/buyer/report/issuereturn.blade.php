...
@section('content')
    <div class="card rounded">
        ...
        <div class="card-header bg-white">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h1 class="font-size-22 mb-0">Issued Return Report</h1>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 pt-3 mb-3">
                ...
                <div class="col-6 col-sm-auto">
                    <button type="button"
                        class="ra-btn ra-btn-outline-danger w-100 justify-content-center font-size-11" onClick="window.location.href='{{ route('buyer.report.issuereturn') }}'">
            ...
            <div class="table-responsive table-inventory">
                <table class="product-listing-table w-100 dataTables-example1"  id="report-table">
                    <thead>
                        <tr>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Issued Return Number</th>
                            ...
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Issued Return Type</th>
    ...
    @push('exJs')
        @once
            <script>
                var getissuedReturnlistdataUrl              =   "{{ route('buyer.report.issuedReturnlistdata') }}";
                var getIssuedReturnExportUrl              =   "{{ route('buyer.report.issuedReturnExport') }}";
            ...
            <script src="{{ asset('public/js/issuedReturn.js') }}"></script>
