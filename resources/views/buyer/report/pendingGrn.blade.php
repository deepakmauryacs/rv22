...
@section('content')
                ...
                <table class="product-listing-table w-100 dataTables-example1"  id="report-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Order Quantity</th>
    ...
    @push('exJs')
        @once
            ...
            <script>
                var pendingGrnreportlistdataurl        =    "{{ route('buyer.report.pendingGrnReportlistdata') }}";
                var exportreportlistPendingGrnurl      =    "{{ route('buyer.report.exportPendingGrnReport') }}";
                var deleteExcelUrl="{{route('buyer.delete.export.file')}}";// Pingki Code Update
            </script>
            <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css">
