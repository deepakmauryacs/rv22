...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="table-responsive table-inventory">
                <table class="product-listing-table w-100 dataTables-example1"  id="report-table">
                    <thead>
                        <tr>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Select</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Issued Number</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Product</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Division</th>
                            ...
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Amount ({{ session('user_currency.symbol', '₹')}})</th>
                            ...
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Issued To</th>
                        </tr>
                    </thead>
                </table>
            </div>
    ...
    @push('exJs')
        @once
            <script>
                var getissuedlistdataUrl              =   "{{ route('buyer.report.issuedlistdata') }}";
                var getIssuedExportUrl              =   "{{ route('buyer.report.issuedExport') }}";
