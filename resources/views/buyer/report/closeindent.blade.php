...
@section('content')
    <div class="card rounded">
        ...
        <div class="card-header bg-white">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h1 class="font-size-22 mb-0">Close Indent Report</h1>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 pt-3 mb-3">
                ...
                <div class="col-6 col-sm-auto">
                    <button type="button"
                        class="ra-btn ra-btn-outline-danger w-100 justify-content-center font-size-11" onClick="window.location.href='{{ route('buyer.report.closeindent') }}'">
    ...
    @push('exJs')
        @once
            ...
            <script src="{{ asset('public/js/closeindent.js') }}"></script>
            ...
            <script>
                var closeindentreportlistdataurl        =   "{{ route('buyer.report.closeindentlistdata') }}";
                var exportreportlistcloseindenturl      =    "{{ route('buyer.report.exportcloseIndentReport') }}";
                var opentdcloseindenturl                =    "{{ route('buyer.report.closeindentdata') }}";
