...
<div class="card" style="margin: 25px;">
    <div class="card-header">
        <h5>Edit Role with Permissions</h5>
    </div>
    ...
    <form id="edit-role-form">
        ...
        <div class="card-body">
            <div class="row"> 
                <div class="col-md-6">
                    <div class="mb-3">
                        <input type="text" name="role_name" class="form-control" placeholder="Enter Role Name" value="{{ $userRole->role_name }}" required>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($module->available_permissions['add'])
                                        <input type="checkbox" name="permissions[{{ $module->id }}][can_add]" value="1"
                                            class="add-checkbox"
                                            @if($rolePermissions && $rolePermissions->can_add) checked @endif>
                                    @else
                                        <span>x</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    @if($module->available_permissions['edit'])
                                        <input type="checkbox" name="permissions[{{ $module->id }}][can_edit]" value="1"
                                            class="edit-checkbox"
                                            @if($rolePermissions && $rolePermissions->can_edit) checked @endif>
                                    @else
                                        <span>x</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    @if($module->available_permissions['delete'])
                                        <input type="checkbox" name="permissions[{{ $module->id }}][can_delete]" value="1"
                                            class="delete-checkbox"
                                            @if($rolePermissions && $rolePermissions->can_delete) checked @endif>
                                    @else
                                        <span>x</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    @if($module->available_permissions['view'])
                                        <input type="checkbox" name="permissions[{{ $module->id }}][can_view]" value="1"
                                            class="view-checkbox"
                                            @if($rolePermissions && $rolePermissions->can_view) checked @endif>
                                    @else
                                        <span>x</span>
                                    @endif
                                </td>
