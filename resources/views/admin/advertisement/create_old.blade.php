@extends('admin.layouts.app',['title'=>'Manage Advertisement','sub_title'=>'Create'])
...
<div class="container-fluid">
    <div class="card shadow mb-4 mt-3">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 text-primary">Add New Advertisement</h5>
        </div>
        <div class="card-body">
            <form id="create-form" action="{{route('admin.advertisement.store')}}" method="post">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="buyer_vendor_name" name="buyer_vendor_name"
                                placeholder="Buyer Name/ Vendor Name">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 p-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input autocomplete="off" onblur="set_to_date();" type="date" class="form-control" placeholder=" Form Validity Period" value="" id="validity_period_from" name="validity_period_from" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                <span class="text-danger error-text validity_period_from_error"></span>
                            </div>
                            <div class="col-md-6">
                                <input autocomplete="off" type="date" class="form-control" placeholder="To Validity Period" value="" id="validity_period_to" name="validity_period_to" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57">   
