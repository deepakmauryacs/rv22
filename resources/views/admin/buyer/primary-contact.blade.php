@extends('admin.layouts.app_second',['title' => 'Buyer','sub_title' => 'Primary Contact'])
@section('breadcrumb')
<style type="text/css">
    /* Form group styling */
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-global py-2 mb-0">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{ route('admin.buyer.index') }}"> Buyer </a>
                </li>
        ...
        <div class="col-xl-6 col-lg-8 col-md-9 col-sm-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form id="buyer-profile-form" action="{{ route('admin.buyer.primaryContactDetailsUpdate') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
