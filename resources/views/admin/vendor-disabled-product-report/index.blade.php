                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                                ...
                                <div class="row gx-3">
                                    <div class="col-12 col-sm-auto mt-3 mt-sm-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" name="product_name" class="form-control fillter-form-control w-100" value="{{ request('product_name') }}" placeholder="Product Name">
                                    ...
                                    <div class="col-12 col-sm-auto mt-3 mt-sm-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" name="vendor_name" class="form-control fillter-form-control w-100" value="{{ request('vendor_name') }}" placeholder="Vendor Name">
                                                <label>Vendor Name</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto mt-3 mt-sm-4">
                                        <button type="submit" class="btn-style btn-style-primary d-flex align-items-center"><i class="bi bi-search d-none d-sm-block"></i> Search</button>
                                    </div>
                                    <div class="col-auto mt-3 mt-sm-4">
                                        <a href="{{ route('admin.vendor-disabled-product-report.index') }}" class="btn-style btn-style-danger d-flex align-items-center">RESET</a>
                                    </div>
                                    <div class="col-auto mt-3 mt-sm-4">
                                        <button type="button" id="export-btn" class="btn-rfq btn-rfq-white d-flex align-items-center">
                                            <i class="bi bi-download d-none d-sm-block"></i> Export
                                        </button>
                                    </div>
                                    <div class="col-auto mt-3 mt-sm-4">
                                        <button type="button" id="delete-btn" class="btn-rfq btn-rfq-danger d-flex align-items-center">
                                            <i class="bi bi-trash d-none d-sm-block"></i> Delete
                                        </button>
                                    </div>
                                </div>
                            <!-- <ul class="rfq-filter-button">
                                    ...
                                    <li>
                                        <div class="d-flex flex-wrap align-items-center justify-content-between justify-content-sm-start gap-2">
                                            <button type="submit" class="btn-style btn-style-primary d-flex align-items-center"><i class="bi bi-search d-none d-sm-block"></i> Search</button>
                                            <a href="{{ route('admin.vendor-disabled-product-report.index') }}" class="btn-style btn-style-danger d-flex align-items-center">RESET</a>
                                            <button type="button" id="export-btn" class="btn-rfq btn-rfq-white d-flex align-items-center">
                                                <i class="bi bi-download d-none d-sm-block"></i> Export
