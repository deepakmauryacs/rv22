        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-global py-2 mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.verified-products.index') }}">Verified Products</a>
                    </li>
                            ...
                            <div class="basic-form pro_edit">
                                <form id="editVerifiedProductForm" method="POST" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 d-flex align-items-center">
                                            <span class="text-danger small">(JPEG/JPG/PNG/GIF)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center">
                                            <span class="text-danger small">(PDF/Image/Document)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-2 mb-2 mb-sm-0 d-flex align-items-center">
                        ...
                        if (response.status == 1) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    "{{ route('admin.verified-products.index') }}";
                            }, 300);
                        } else {
