<div class="message-detail-container p-3 p-sm-4 py-0 py-sm-0">
        ...
        <div class="col-auto col-sm-6">
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="button" class="ra-btn ra-btn-outline-primary back-btn"
                    wire:click="replyBack('{{ $listing_type }}')">Back</button>
            </div>
    ...
    <div class="message-details-scroll-container chat-container1" wire:poll.keep-alive id="chatMessages">
        ...
        <div class="mb-3 {{ $data->sender_id == Auth::user()->id ? 'message-detail-sender' : 'message-detail-user' }}">
            <div
            ...
            <div class="message-details-attachment d-flex mt-2">
                @if ($data->file_path)
                <a href="{{ url('public/' . $data->file_path) }}" download="{{ url('public/' . $data->file_path) }}"
                    class="ra-btn ra-btn-outline-primary" class="ra-btn ra-btn-outline-primary">
                    <span
        ...
        {{-- {{ dd($listing_type,$listingData[0]->sender_draft_status) }} --}}
        ...
        <div class="chat-input p-3 border-top">
            <form id="chatForm" wire:submit.prevent="replyMessage">
                ...
                <div class="input-group">
                    ...
                    <input wire:model="attachment" type="file" id="attachment" name="attachment" class="d-none"
