    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-global py-2 mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('vendor.direct_order.index') }}">Orders Confirmed</a></li>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between bg-white py-3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-auto">
                        <button type="button" onclick="window.location.href='{{ route('vendor.direct_order.index') }}';"
                        ...
                        <table class="table ra-table ra-table-stripped rfq-order-details-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$value->inventory->specification}}</td>
                                    <td>{{$value->inventory->size}}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-end"> ₹{{IND_money_format($gtotal)}}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
